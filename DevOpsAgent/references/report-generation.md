...
If yes, generate a styled HTML version of the report directly. Apply professional styling with:
- AWS-branded color scheme (dark header, orange accents)
- Responsive table layout
- Syntax-highlighted code blocks
- Rating badges (GREEN/AMBER/RED) with color coding

Output the HTML file alongside the markdown report with the same filename but `.html` extension.
